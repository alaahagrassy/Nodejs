...
module.exports.register =async (req, res, next) => {
    const { email, firstName, lastName, password, country, street, phone,admin} = req.body;
   ...
   const newUser=new UserModel({
    email, firstName, lastName, hashedPassword:password, country, street, phone,admin
   }).save()
   .then((data,error)=>{
       if(error)
       {
